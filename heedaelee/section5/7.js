...
function solution(fW, sW) {
  ...
  for (let [key, value] of hS) {
    ...
    if (hS2.has(key)) {
      if (value !== hS2.get(key)) {
        console.log('해당 문자들은 있는데, 문자별 갯수가 다름');
        return "NO";
      }
    }
  }
...
// let fstWords = "AbaAeCe";
// let secWords = "baeeACA";

let fstWords = 'abaCC';
let secWords = 'Caaab';

console.log(solution(fstWords, secWords));
